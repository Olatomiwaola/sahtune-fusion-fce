...
| 9 | M5 | Finalize fusion-kernel interface, high-water-mark propagation, explicit-permit merge check, segregation-on-block — tested against FCE-REQ-KRN-011 | Fusion-kernel spec, merge decision model | Chat | 0.5–1 day | — | OPEN 2026-07-06 — GATE-B satisfied (b6b4d24); FU-M4S8-1 closed at M5 open; Sprint 9 in progress |
